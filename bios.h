...
/**
   @brief Initialize the BIOS/Hardware layer.
   
   This function must be called before any other BIOS function.
   It sets up the "hardware" (signals, timers, etc.) for the process.
   
   @param serialno the number of serial ports to support.
*/
